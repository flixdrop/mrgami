...
} from "../services/seller-form-api.service";
...
export class SellerFormPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http
      .get(
        "https://gist.githubusercontent.com/Dhaneshmonds/1b0ca257b1c34e4842528dcb826ee880/raw/3a7d98354cc43158162eb47d990073105788f348/IndianStatesDistricts.json"
      )
      .subscribe((res) => {
        console.log("res- ", res);
        this.stateList = res;
